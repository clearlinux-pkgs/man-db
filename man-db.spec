...
Version  : 2.7.4
Release  : 12
URL      : http://nongnu.askapache.com/man-db/man-db-2.7.4.tar.xz
Source0  : http://nongnu.askapache.com/man-db/man-db-2.7.4.tar.xz
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/man-db/libman-2.7.4.so
/usr/lib64/man-db/libman.so
/usr/lib64/man-db/libmandb-2.7.4.so
