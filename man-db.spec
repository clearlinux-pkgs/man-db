...
Version  : 2.12.1
Release  : 55
URL      : https://download.savannah.nongnu.org/releases/man-db/man-db-2.12.1.tar.xz
Source0  : https://download.savannah.nongnu.org/releases/man-db/man-db-2.12.1.tar.xz
Source1  : https://download.savannah.nongnu.org/releases/man-db/man-db-2.12.1.tar.xz.asc
...
%setup -q -n man-db-2.12.1
cd %{_builddir}/man-db-2.12.1
%patch -P 1 -p1
pushd ..
cp -a man-db-2.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719976061
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/man-db/libman-2.12.1.so
/V3/usr/lib64/man-db/libmandb-2.12.1.so
/usr/lib64/man-db/libman-2.12.1.so
/usr/lib64/man-db/libman.so
/usr/lib64/man-db/libmandb-2.12.1.so
